...
internal class ResticJob : DejaDup.ToolJob
{
  ...
  void handle_done(ResticInstance? inst, bool success, bool cancelled)
  {
    string detail = null;
  ...
  void handle_message(ResticInstance inst, string[] control_line,
